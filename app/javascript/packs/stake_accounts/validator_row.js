        ...
        <div class="column-info-row" data-turbolinks=false>
          ...
          <div class="column-info-name">
            ...
            <small class="text-nowrap">
              <i :class=" 'fa-solid fa-circle me-1 score-' + validator['root_distance_score'] "
                 :title=" 'Root Distance Score = ' + validator['root_distance_score'] "></i>
              <i :class=" 'fa-solid fa-circle me-1 score-' + validator['vote_distance_score'] "
                 :title=" 'Vote Distance Score = ' + validator['vote_distance_score'] "></i>
              <i :class=" 'fa-solid fa-circle me-1 score-' + validator['skipped_slot_score'] "
                 :title=" 'Skipped Slot Score = ' + validator['skipped_slot_score'] "></i>
              <i :class=" 'fa-solid fa-circle me-1 score-' + validator['published_information_score'] "
                 :title=" 'Published Information Score = ' + validator['published_information_score'] "></i>
              <i :class=" 'fa-solid fa-circle me-1 score-' + validator['software_version_score'] "
                 :title=" 'Software Version Score = ' + validator['software_version_score'] "></i>
              <i :class=" 'fa-solid fa-circle me-1 score-' + validator['security_report_score'] "
                 :title=" 'Bonus Point = ' + validator['security_report_score'] "></i>
              <i class="fa-solid fa-circle-minus me-1 text-warning"
