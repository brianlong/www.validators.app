  ...
  def block_history_get
    lambda do |p|
      ...
      p.payload[:validators].each do |validator|
        ...
        validator.validator_score_v1.skipped_slot_history_push(skipped_slot_percent.to_f)

        moving_average = last_validator_block_history_for_validator[2]
        validator.validator_score_v1.skipped_slot_moving_average_history_push(moving_average.to_f)
      rescue StandardError => e
        Appsignal.send_error(e)
      end
