...
class ValidatorScoreV2 < ApplicationRecord
  ...
  # Assign a score based on published information. We assign 1/2 point for each element of published information.
  # After assigning the individual scores, we round down to the nearest integer. 1 point if there are two or three
  # pieces of data. 2 points if all for elements are not blank.
