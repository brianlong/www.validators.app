...
ActiveRecord::Schema.define(version: 2026_09_02_010000) do
  ...
  create_table "stake_account_histories", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.integer "epoch"
    t.float "apy"
    t.index ["epoch"], name: "index_stake_account_histories_on_epoch"
    t.index ["network", "epoch"], name: "index_stake_account_histories_on_network_and_epoch"
  ...
  create_table "stake_accounts", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.index ["network", "active_stake"], name: "index_stake_accounts_on_network_and_active_stake"
  ...
  create_table "validators", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.integer "doublezero_type", default: 0
