...
ActiveRecord::Schema.define(version: 20_200_810_200_009) do
  ...
  create_table 'batches', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8', force: :cascade do |t|
    ...
    t.string 'network'
    t.index %w[network created_at], name: 'index_batches_on_network_and_created_at'
    t.index %w[network uuid], name: 'index_batches_on_network_and_uuid'
  end
  ...
  create_table 'epoch_histories', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8', force: :cascade do |t|
    ...
    t.datetime 'updated_at', precision: 6, null: false
    t.string 'network'
    t.index %w[network batch_uuid], name: 'index_epoch_histories_on_network_and_batch_uuid'
  end
  ...
  create_table 'ping_time_stats', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8', force: :cascade do |t|
    ...
    t.datetime 'updated_at', precision: 6, null: false
    t.string 'network'
    t.index %w[network batch_uuid], name: 'index_ping_time_stats_on_network_and_batch_uuid'
  end
  ...
  create_table 'ping_times', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[network batch_uuid], name: 'index_ping_times_on_network_and_batch_uuid'
    t.index %w[network from_account created_at], name: 'index_ping_times_on_network_and_from_account_and_created_at'
    t.index %w[network from_account to_account created_at], name: 'ndx_network_from_to_account'
    t.index %w[network from_ip created_at], name: 'index_ping_times_on_network_and_from_ip_and_created_at'
    t.index %w[network from_ip to_ip created_at], name: 'index_ping_times_on_network_and_from_ip_and_to_ip_and_created_at'
    t.index %w[network to_account created_at], name: 'index_ping_times_on_network_and_to_account_and_created_at'
    t.index %w[network to_account from_account created_at], name: 'ndx_network_to_from_account'
    t.index %w[network to_ip created_at], name: 'index_ping_times_on_network_and_to_ip_and_created_at'
    t.index %w[network to_ip from_ip created_at], name: 'index_ping_times_on_network_and_to_ip_and_from_ip_and_created_at'
  end
  ...
  create_table 'reports', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[network batch_uuid], name: 'index_reports_on_network_and_batch_uuid'
    t.index %w[network name created_at], name: 'index_reports_on_network_and_name_and_created_at'
  end
  ...
  create_table 'spark_lines', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[network spark_group batch_uuid], name: 'index_spark_lines_on_network_and_spark_group_and_batch_uuid'
  end
  ...
  create_table 'validator_block_histories', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8', force: :cascade do |t|
    ...
    t.string 'network'
    t.index %w[network batch_uuid], name: 'index_validator_block_histories_on_network_and_batch_uuid'
    t.index %w[validator_id created_at], name: 'index_validator_block_histories_on_validator_id_and_created_at'
    t.index %w[validator_id epoch], name: 'index_validator_block_histories_on_validator_id_and_epoch'
  ...
  create_table 'validator_block_history_stats', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8', force: :cascade do |t|
    ...
    t.datetime 'updated_at', precision: 6, null: false
    t.string 'network'
    t.index %w[network batch_uuid], name: 'index_validator_block_history_stats_on_network_and_batch_uuid'
  end
  ...
  create_table 'validator_histories', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[network batch_uuid], name: 'index_validator_histories_on_network_and_batch_uuid'
  end
  ...
  create_table 'validator_ips', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[validator_id version address], name: 'index_validator_ips_on_validator_id_and_version_and_address', unique: true
  ...
  create_table 'validators', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8', force: :cascade do |t|
    ...
    t.string 'avatar_url'
    t.index %w[network account], name: 'index_validators_on_network_and_account', unique: true
  end
  ...
  create_table 'vote_account_histories', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8', force: :cascade do |t|
    ...
    t.string 'network'
    t.string 'batch_uuid'
    t.index %w[network batch_uuid], name: 'index_vote_account_histories_on_network_and_batch_uuid'
    t.index %w[vote_account_id created_at], name: 'index_vote_account_histories_on_vote_account_id_and_created_at'
  ...
  create_table 'vote_accounts', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[account created_at], name: 'index_vote_accounts_on_account_and_created_at'
    t.index %w[validator_id account], name: 'index_vote_accounts_on_validator_id_and_account', unique: true
