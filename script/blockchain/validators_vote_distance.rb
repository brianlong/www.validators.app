...
# validators_votes = {}
# total_batches = Blockchain::MainnetTransaction.where(epoch: 684).count / 5000
# Blockchain::MainnetTransaction.where(epoch: 684).find_in_batches(batch_size: 5000).with_index do |tx_batch, batch_index|
