...
#
# Helsinki
# insert into ip_overrides (address, traits_autonomous_system_number, country_iso_code, country_name, city_name, data_center_key, data_center_host, created_at, updated_at) VALUES ('135.181.181.119 ', 24940, 'FI', 'Finland', 'Helsinki', '24940-FI-Helsinki', 'core32.hel1.hetzner.com', NOW(), NOW());
#
# Falkenstein
# insert into ip_overrides (address, traits_autonomous_system_number, country_iso_code, country_name, city_name, data_center_key, data_center_host, created_at, updated_at) VALUES ('168.119.213.165 ', 24940, 'DE', 'Germany', 'Falkenstein', '24940-DE-Falkenstein', 'core24.fsn1.hetzner.com', NOW(), NOW());
#
...
#
# UPDATE validator_score_v1s sc INNER JOIN ips ip ON sc.ip_address = ip.address SET sc.data_center_key = ip.data_center_key, sc.updated_at = NOW();
