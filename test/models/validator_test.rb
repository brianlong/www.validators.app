...
class ValidatorTest < ActiveSupport::TestCase
  ...
  test '#private_validator? returns true if validator\'s commission is 100%' do
    ...
    assert create(:validator_score_v2, commission: 100, validator: validator).validator.private_validator?
    refute create(:validator_score_v2, commission: 99, validator: validator).validator.private_validator?
  end
