...
class ValidatorUpdateAvatarUrlTest < ActiveSupport::TestCase
  ...
  test "validators with correct urls" do
    ...
    VCR.use_cassette('validators_update_keybase_avatar_url/validators_with_correct_urls', record: :new_episodes) do
  ...
  test "validators with broken urls" do
    ...
    VCR.use_cassette('validators_update_keybase_avatar_url/validators_with_broken_urls', record: :new_episodes) do
  ...
  test "validators with default urls" do
    ...
    VCR.use_cassette('validators_update_keybase_avatar_url/validators_with_default_urls', record: :new_episodes) do
