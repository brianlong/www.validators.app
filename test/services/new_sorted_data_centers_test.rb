...
class NewSortedDataCenterTest < ActiveSupport::TestCase
  ...
  test "NewSortedDataCenters when sort_by_asn returns correct result" do
    result = NewSortedDataCenters.new(
      sort_by: "asn",
      network: "testnet"
    ).call
  ...
  test "NewSortedDataCenters when sort_by_data_centers returns correct result" do
    result = NewSortedDataCenters.new(
      sort_by: "data_center",
      network: "testnet"
    ).call
